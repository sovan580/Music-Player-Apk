...
public class AlbumDetailsAdapter extends RecyclerView.Adapter<AlbumDetailsAdapter.MyHolder> {
    ...
    static ArrayList<Music> albumFiles;
    View view;
    public AlbumDetailsAdapter(Context mContext,ArrayList<Music> albumFiles){
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        if(image!=null){
            ...
            Glide.with(mContext).load(R.drawable.song).into(holder.album_image);
        }
